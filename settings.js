...
module.exports = {
  // ===== BOT CORE SETTINGS =====
  SESSION_ID: process.env.SESSION_ID || "drakonis~p303GB7K#_9HY2V_qyDXn2a64U8j3lxJbDqpjPVY24cZggwd-JD4", // Your bot's session ID (keep secure)
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "263777143277", // Owner WhatsApp number
  OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "TKM", // Owner name
  DEV: process.env.DEV || "263777143277", // Developer contact number
